...
class Data{
	...
	{
		return self::$connection->send(self::getData("send_private_msg", ['user_id' => $user_id, 'message' => $msg, 'auto_escape' => $auto_escape], 'MessageData'));
	}
	...
	{
		return self::$connection->send(self::getData("send_group_msg", ['group_id' => $group_id, 'message' => $msg, 'auto_escape' => $auto_escape], 'MessageData'));
	}
	...
	{
		return self::$connection->send(self::getData("send_msg", ['message_type' => $message_type, 'user_id' => $user_id, 'group_id' => $group_id, 'message' => $msg, 'auto_escape' => $auto_escape], 'MessageData'));
	}
	...
	{
		return self::$connection->send(self::getData("get_msg", ['message_id' => $message_id], 'GetMessageData'));
	}
	...
	{
		return self::$connection->send(self::getData("get_forward_msg", ['id' => $id], 'GetForwardMessageData'));
	}
	...
	{
		return self::$connection->send(self::getData("get_login_info", null, "InfoData"));
	}
	...
	{
		return self::$connection->send(self::getData("get_stranger_info", ['user_id' => $user_id, 'no_cache' => $no_cache], 'StrangerInfoData'));
	}
	...
	{
		return self::$connection->send(self::getData("get_friend_list", null, 'StrangerInfoData'));
	}
	...
	{
		return self::$connection->send(self::getData("get_group_info", ['group_id' => $group_id, 'no_cache' => $no_cache], 'FriendData'));
	}
	...
	{
		return self::$connection->send(self::getData("get_group_list", null, 'GroupData'));
	}
	...
	{
		return self::$connection->send(self::getData("get_group_member_info", ['group_id' => $group_id, 'user_id' => $user_id, 'no_cache' => $no_cache], 'GroupInfoData'));
	}
	...
	{
		return self::$connection->send(self::getData("get_group_member_list", ['group_id' => $group_id], 'MemberInfoData'));
	}
	...
	{
		return self::$connection->send(self::getData("get_group_honor_info", ['group_id' => $group_id, 'type' => $type], 'HonorInfoData'));
	}
